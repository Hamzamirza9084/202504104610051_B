...
<div class="container mx-auto px-4 py-8 max-w-md">
    <h1 class="text-3xl font-bold text-gray-900 mb-8">Add New Expense</h1>

    <form method="POST" action="{{ route('expenses.store') }}" class="bg-white shadow-md rounded-lg p-8">
        @csrf
        ...
        <div class="flex space-x-4">
            <button type="submit" class="flex-1 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md transition duration-200">
                Add Expense
            </button>
